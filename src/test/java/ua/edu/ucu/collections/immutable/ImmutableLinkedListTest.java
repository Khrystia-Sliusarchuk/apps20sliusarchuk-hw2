...
public class ImmutableLinkedListTest {
    private ImmutableLinkedList oneElemArr;
    private ImmutableLinkedList emptyArr;
    private ImmutableLinkedList simpleArr;
    private Object[] exampleArr = new Object[]{1, 2, 3, "lol"};
    private Object[] invalidExampleArr = new Object[]{1, 2, 3, null};

    @Before
    public void setUp() {
        oneElemArr = new ImmutableLinkedList(new Object[]{1});
        emptyArr = new ImmutableLinkedList();
        simpleArr = new ImmutableLinkedList(new Object[]{1, 2, 3});
    }
    ...
    public void testAddOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 1});
    ...
    public void testAddEmptyArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1});
    ...
    public void testAddSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 3, 1});
    ...
    public void testAddWithIndexOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{"lol", 1});
    ...
    public void testAddWithIndexSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 3, "lol"});
    ...
    public void testAddAllOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 1, 2, 3, "lol"});
    ...
    public void testAddAllSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 3, 1, 2, 3, "lol"});
    ...
    public void testAddAllWithIndexOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 3, "lol", 1});
    ...
    public void testAddAllWithIndexSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 1, 2, 3, "lol", 2, 3});
    ...
    public void testRemoveOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList();
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }
    ...
    public void testRemoveSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2});
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }
    ...
    public void testSetOneElemArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{2});
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }
    ...
    public void testSetSimpleArr() {
        ...
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 10});
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }
    ...
    @Test
    public void testAddFirstOneElemArr() {
        ImmutableLinkedList actual = oneElemArr.addFirst(2);

        ImmutableList expected = new ImmutableLinkedList(new Object[]{2, 1});
    ...
    @Test
    public void testAddFirstEmptyArr() {
        ImmutableLinkedList actual = emptyArr.addFirst(2);
    ...
    @Test
    public void testAddFirstSimpleArr() {
        ImmutableLinkedList actual = simpleArr.addFirst(8);

        ImmutableList expected = new ImmutableLinkedList(new Object[]{8, 1, 2, 3});
    ...
    @Test(expected = InputMismatchException.class)
    public void testAddFirstSimpleArrInvalidInput() {
        ImmutableList actual = simpleArr.addFirst(null);
    }

    @Test
    public void testAddLastOneElemArr() {
        ImmutableLinkedList actual = oneElemArr.addLast(2);
    ...
    @Test
    public void testAddLastEmptyArr() {
        ImmutableLinkedList actual = emptyArr.addLast(2);
    ...
    @Test
    public void testAddLastSimpleArr() {
        ImmutableLinkedList actual = simpleArr.addLast(8);

        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2, 3, 8});
    ...
    @Test(expected = InputMismatchException.class)
    public void testAddLastSimpleArrInvalidInput() {
        ImmutableList actual = simpleArr.addLast(null);
    }

    @Test
    public void testGetFirstOneElemArr() {
        assertEquals(1, oneElemArr.getFirst());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testGetFirstEmptyArr() {
        emptyArr.getFirst();
    }

    @Test
    public void testGetFirstSimpleArr() {
        assertEquals(1, simpleArr.getFirst());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }

    @Test
    public void testGetLastOneElemArr() {
        assertEquals(1, oneElemArr.getLast());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testGetLastEmptyArr() {
        emptyArr.getLast();
    }

    @Test
    public void testGetLastSimpleArr() {
        assertEquals(3, simpleArr.getLast());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }

    @Test
    public void testRemoveFirstOneElemArr() {
        ImmutableList actual = oneElemArr.removeFirst();
        ImmutableList expected = new ImmutableLinkedList();
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void testRemoveFirstEmptyArr() {
        emptyArr.removeFirst();
    }

    @Test
    public void testRemoveFirstSimpleArr() {
        ImmutableList actual = simpleArr.removeFirst();
        ImmutableList expected = new ImmutableLinkedList(new Object[]{2, 3});
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }

    @Test
    public void testRemoveLastOneElemArr() {
        ImmutableList actual = oneElemArr.removeLast();
        ImmutableList expected = new ImmutableLinkedList();
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(oneElemArr.toArray(), new Object[]{1});
    }
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void testRemoveLastEmptyArr() {
        emptyArr.removeLast();
    }

    @Test
    public void testRemoveLastSimpleArr() {
        ImmutableList actual = simpleArr.removeLast();
        ImmutableList expected = new ImmutableLinkedList(new Object[]{1, 2});
        assertArrayEquals(actual.toArray(), expected.toArray());
        assertArrayEquals(simpleArr.toArray(), new Object[]{1, 2, 3});
    }
